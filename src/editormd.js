;(function(factory) {
  ...
  editormd.defaults = {
    ...
    lang: {
      name: "zh-cn",
      description:
        "在线Markdown编辑器<br/>支持文本、图片、链接、公式、流程图.",
      tocTitle: "目录",
      toolbar: {
        undo: "撤销（Ctrl+Z）",
        redo: "重做（Ctrl+Y）",
  ...
  editormd.prototype = editormd.fn = {
    ...
    createInfoDialog: function() {
      ...
      var infoDialogHTML = [
        ...
        '<p style="margin: 10px 0 20px 0;"><a href="http://u.720life.cn/s/75244496" target="_blank">官方交流Q群:1142802013'+
          ' <i class="fa fa-external-link"></i></a></p>',
        '<p style="font-size: 0.85em;">Copyright &copy; 2020 Pandao, The MIT License.</p>',
        "</div>",
        '<a href="javascript:;" class="fa fa-close ' +
          classPrefix +
          'dialog-close"></a>',
